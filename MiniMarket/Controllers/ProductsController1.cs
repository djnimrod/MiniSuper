...
namespace MiniMarket.Controllers
{
    public class ProductsController1 : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Precio,FechaVencimiento,CategoryID,UnitID,ProviderID")] Product product, HttpPostedFileBase imagenProducto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Precio,FechaVencimiento,CategoryID,UnitID,ProviderID")] Product product, HttpPostedFileBase imagenProducto)
        {
            if (imagenProducto != null && imagenProducto.ContentLength > 0)
            {
        ...
        public void MostrarQr(Product p) {
